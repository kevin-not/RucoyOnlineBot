...
class Rectangle:
    ...
    def click(self):
        ahk.mouse_move(self.center.x, self.center.y)
        ahk.click(self.center.x, self.center.y)
        time.sleep(1)


def create_rectangle_from_ahk_window(ahk_window):
    p = ahk_window.get_position()
